...
namespace Ophim\ThemeCoco;

use Illuminate\Foundation\Support\Providers\AuthServiceProvider as ServiceProvider;

class ThemeCocoServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('themes/coco')
        ], 'coco-assets');
    }
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'coco' => [
                ...
                'package_name' => 'ophimcms/theme-coco',
                'publishes' => ['coco-assets'],
                'preview_image' => '',
                'options' => [
                    [
                        'name' => 'per_page_limit',
